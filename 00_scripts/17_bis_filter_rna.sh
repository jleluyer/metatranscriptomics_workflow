...
#usage sorterna
repodb="/00_ressources/rRNA_database"
REPO="scratch/capamax/03_trimmed"
repo_rna="scratch/capamax/04_filtered_rna"
repo_non_rna="scratch/capamax/04_filtered_non_rna"
base=__BASE__
NCPU=12
